            ...
            <div class="col-md-4 col-xl-3">
                <div class="card mb-3">
                    ...
                    <div class="card-body text-center">
                        <img
                            src="{{ asset('asset/img/avatars/avatar-4.jpg')}}"
                            alt="Stacie Hall"
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1">
                                <span class="fas fa-globe fa-fw mr-1"></span>
                                <a href="#">staciehall.co</a>
                            </li>
                            <li class="mb-1">
                                <span class="fab fa-twitter fa-fw mr-1"></span>
                                <a href="#">Twitter</a>
                            </li>
                            <li class="mb-1">
                                <span class="fab fa-facebook fa-fw mr-1"></span>
                                <a href="#">Facebook</a>
                            </li>
                            <li class="mb-1">
                                <span class="fab fa-instagram fa-fw mr-1"></span>
                                <a href="#">Instagram</a>
                            </li>
                            <li class="mb-1">
                                <span class="fab fa-linkedin fa-fw mr-1"></span>
                                <a href="#">LinkedIn</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-md-8 col-xl-9">
                <div class="card">
                    ...
                    <div class="card-body h-100">
                        <div class="media">
                            <img src="{{ asset('asset\img\avatars\avatar-5.jpg')}}"
                                width="36"
                                height="36"
                        ...
                        <div class="media">
                            <img
                                src="{{asset('asset/img/avatars/avatar-2.jpg')}}"
                                width="36"
                                height="36"
                                class="rounded-circle mr-2"
                                alt="Carl Jenkins"
                            ...
                            <div class="media-body">
                                ...
                                <div class="row no-gutters mt-1">
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <img
                                            src="{{asset('asset\img\photos\unsplash-1.jpg')}}"
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <img
                                            src="{{asset('asset\img\photos\unsplash-2.jpg')}}"
                                            class="img-fluid pr-2"
                                            alt="Unsplash"
                                        />
                                    </div>
